  ...
  <div id="todo-list-example" class="container">
    ...
    <div class="row">
      <div class="col-md-6 mx-auto">
        <h1 class="text-center">Toxic comment Detection</h1>
        <form v-on:submit.prevent="addNewTask">
          <label for="tasknameinput">Prediction DEMO</label>
          <input v-model="taskname" type="text" id="tasknameinput" class="form-control" placeholder="Enter Comment">
