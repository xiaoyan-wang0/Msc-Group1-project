        ...
        <div class="col-lg-4 col-md-4">
          <div class="anime__details__sidebar">
            ...
            >
              ...
              >
                <div class="product__sidebar__comment__item__pic tests">
                  <img
...
.tests{
  ...
  .tests:hover{
   -webkit-box-shadow: 2px 12px 10px rgb(100, 98, 98);
    -moz-box-shadow: 2px 12px 10px  rgb(100, 98, 98);
    box-shadow: 2px 12px 10px rgb(100, 98, 98);
